...
const ProductList = async ({category, params}: {category: string, params: "homepage" | "products"}) => {
    const request = await fetch(`${BASE_URL}/api/products${category && category !== "all" ? `?category=${category}` : ""}`, {
        cache: "no-store",
    });
